...
// Credit to https://gist.github.com/eyalroz/858d7beae1ad09b83b691107306d0176
...
namespace cuda
{
  ...
  */
  ...
  // Yibo: not sure why it causes compiling error 
#if 0 //!defined(__STRICT_ANSI__) && defined(_GLIBCXX_USE_INT128)
