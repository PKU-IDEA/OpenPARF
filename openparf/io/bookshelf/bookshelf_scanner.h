...
#ifndef BOOKSHELFPARSER_SCANNER_H_
#define BOOKSHELFPARSER_SCANNER_H_
...
#define YY_DECL                                                                \
  bookshelfparser::Parser::token_type bookshelfparser::Scanner::lex(           \
      bookshelfparser::Parser::semantic_type *yylval,                          \
      bookshelfparser::Parser::location_type *yylloc)
#endif
...
class Scanner : public BookshelfParserFlexLexer {
public:
