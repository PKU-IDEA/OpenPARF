...
namespace lemon {
  ...
  private:
    ...
    void startMinMeanCycleCanceling() {
      ...
      const double XARCH_ITER_LIMIT_FACTOR = 1.0;
      const int XARCH_ITER_LIMIT_MIN_VALUE = 5;

      const int hw_iter_limit =
          std::max(static_cast<int>(XARCH_ITER_LIMIT_FACTOR * _node_num),
                   XARCH_ITER_LIMIT_MIN_VALUE);
